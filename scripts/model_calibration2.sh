...
#
#$ -S /bin/bash
#$ -N model_calibration2
#$ -o /mnt/matylda3/qestienne/projects/ucpa/logs/model_calibration2_out.log
#$ -e /mnt/matylda3/qestienne/projects/ucpa/logs/model_calibration2_err.log
#$ -q long.q
